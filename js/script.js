var quoter = (function(quotes) {
  ...
  return {
    printQuote: function() {
      ...
      autoPlay = window.setTimeout(quoter.printQuote, 10000);
    }
  }
...
$('#loadQuote').click(quoter.printQuote)

// // Set an autoplay timer
autoPlay = window.setTimeout(quoter.printQuote, 5000);
